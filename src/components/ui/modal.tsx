...
export function Modal({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div className={`relative z-10 max-h-screen max-h-[var(--app-vvh,100dvh)] w-full overflow-hidden sm:max-h-[92vh] sm:max-h-[92dvh] sm:rounded-2xl sm:shadow-2xl ${size === "md" ? "max-w-md" : size === "xl" ? "max-w-[1400px]" : "max-w-3xl"}`}>
