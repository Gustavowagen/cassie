        ...
        <Modal onClose={() => setActiveGame(null)} size="xl" dismissible={false} backdropToggle>
          ...
          {activeGame.game_type_id === "tumble" && (
            <Tumble
              ...
              // Passed raw: Tumble normalises it (missing fields, and the
              // pre-2026-08-30 minBet/maxBet names) via resolveFreeSpins.
              freeSpins={(activeGame.settings as TumbleInstanceSettings)?.freeSpins}
              balance={membership?.balance ?? 0}
              minBet={activeGame.min_bet}
              maxBet={activeGame.max_bet}
              onExit={() => setActiveGame(null)}
